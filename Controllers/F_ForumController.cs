...
{
    public class F_ForumController : Controller
    {
        ...
        public ActionResult Index(int? page)
        {
            ...
            if (Session["Account"] != null)
            {
                ...
                {
                    forum.ForumReplys = db.ForumReplies.Where(r => r.ForumId == forum.Id)
                        .Include(r => r.ForumMember)
                        .ToList();
        ...
        public ActionResult ReplyTo(ForumReply forumReply, int? forumId, string Main)
        {
            ...
            // 返回到原始討論頁面或其他頁面
            return RedirectToAction("Details", "F_Forum", new { id = forumId });
        }
