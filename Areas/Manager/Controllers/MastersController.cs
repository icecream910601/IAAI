...
namespace IAAI.Areas.Manager.Controllers
{
    ...
    public class MastersController : Controller
    {
        ...
        // GET: /Manager/Masters/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: /Manager/Masters/Create
